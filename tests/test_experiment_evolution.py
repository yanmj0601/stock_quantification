...
class ExperimentEvolutionTests(TestCase):
    ...
    def test_derive_next_payload_rebalances_crowded_momentum_experiment(self) -> None:
        ...
        proposal = derive_next_factor_backtest_payload(result=result, current_payload=current_payload, current_job_id="job-1")
        ...
        self.assertGreater(float(next_payload["factor_tilts"]["drawdown"]), 0.6)
        self.assertIn("上涨状态", proposal["mutation_reason"])
